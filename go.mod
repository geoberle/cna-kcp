module github.com/geoberle/cna-kcp
...
replace sigs.k8s.io/controller-runtime v0.12.2 => github.com/kcp-dev/controller-runtime v0.12.2-0.20221006162808-d4b60cec23b4
